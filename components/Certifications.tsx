            ...
            >
              {cert.link ? (
                <a
                  ...
                  className="w-full flex flex-col bg-[var(--card-bg)] backdrop-blur-md rounded-3xl p-4 border border-[var(--border-color)] shadow-[0_15px_40px_-15px_var(--shadow-color)] group-hover:shadow-[0_20px_50px_rgba(96,165,250,0.15)] transition-all duration-500"
                >
                  ...
                  <div className="mt-4 flex flex-col justify-between flex-grow">
                    <div className="space-y-1.5">
                      <p className="text-[10px] font-bold text-[#60a5fa] tracking-wider uppercase">
                        Official Credential
                      </p>
                      <h3 className="text-sm md:text-base font-bold text-[var(--text-primary)] leading-snug group-hover:text-[#60a5fa] transition-colors duration-300 line-clamp-2">
                        {cert.title}
                      </h3>
                    </div>

                    <div className="mt-4 pt-3 border-t border-[var(--border-color)] flex items-center justify-between text-xs font-semibold text-indigo-400 group-hover:text-[#60a5fa] transition-colors duration-300">
                      <span>Verify Credential</span>
                      <svg className="w-4 h-4 transform group-hover:translate-x-1 transition-transform duration-300 text-indigo-400 group-hover:text-[#60a5fa]" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
