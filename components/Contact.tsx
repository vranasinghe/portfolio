...
export default function Contact() {
  ...
  return (
    <section className="relative w-full bg-transparent py-24 overflow-hidden border-t border-[var(--border-color)]">
      ...
      <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] bg-[#60a5fa]/5 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          <p className="text-sm font-bold tracking-widest text-[#60a5fa] uppercase mb-3 font-mono">
            CONTACT
          </p>
          <h2 className="text-4xl md:text-5xl font-extrabold text-[var(--text-primary)] mb-4 tracking-tight">
            Get In Touch
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-[#60a5fa] to-indigo-500 mx-auto rounded-full mb-6" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="text-[#60a5fa] font-bold text-xs uppercase tracking-wider mb-2 block font-mono">
                  Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="email" className="text-[#60a5fa] font-bold text-xs uppercase tracking-wider mb-2 block font-mono">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div>
                <label htmlFor="message" className="text-[#60a5fa] font-bold text-xs uppercase tracking-wider mb-2 block font-mono">
                  Message
                </label>
                <textarea
                  id="message"
          ...
          >
            ...
            <p className="text-[var(--text-muted)] text-sm md:text-base leading-relaxed mb-8">
              ...
              <span className="text-[#60a5fa] font-semibold">Data Science</span>,{" "}
              <span className="text-[#60a5fa] font-semibold">AI / ML</span>, or{" "}
              <span className="text-[#60a5fa] font-semibold">Full-Stack Development</span>.{" "}
            ...
            <div className="bg-[var(--card-bg)] border border-[var(--border-color)] p-4 rounded-xl flex items-center justify-between shadow-lg mb-8 max-w-md">
              <div className="flex items-center gap-3 overflow-hidden">
                <svg className="w-5 h-5 text-[#60a5fa] flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="p-2 bg-[var(--bg-tertiary)] border border-[var(--border-color)] rounded-lg text-[var(--text-muted)] hover:text-[var(--text-primary)] hover:border-[#60a5fa] active:scale-95 transition-all duration-200 relative group"
                title="Copy email"
              >
                {copied ? (
            ...
            <div className="flex flex-wrap gap-4">
              <a
                ...
                className="inline-flex items-center gap-2.5 px-5 py-2.5 bg-[var(--card-bg)] border border-[var(--border-color)] rounded-xl text-sm font-semibold text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:border-[var(--accent-color)] transition-all duration-300 shadow-md hover:shadow-lg"
              >
      ...
      <footer className="border-t border-[var(--border-color)] bg-[var(--bg-secondary)] mt-24">
        <div className="max-w-5xl mx-auto px-6 py-10 flex flex-col items-center gap-5">
          <p className="text-sm text-[var(--text-muted)]">
            Designed &amp; Built by{" "}
            <span className="text-[#60a5fa] font-semibold">{personalInfo.name}</span>
          </p>
